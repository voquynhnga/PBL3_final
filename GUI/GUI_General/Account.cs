...
namespace PBL3_qnv.GUI
{
    public partial class Account : Form
    {
        ...
        public Account()
        {
            ...
            richTextBox1.KeyPress += new KeyPressEventHandler(Account_KeyPress);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Controller.Instance.Savein4_NV(textBox1.Text, richTextBox1.Text, textBox3.Text, comboBox1.Text, dateTimePicker1.Value, textBox5.Text, textBox6.Text);
        ...
        void Load_Information()
        {
            ...
            richTextBox1.Text = nv.SDT.ToString();
